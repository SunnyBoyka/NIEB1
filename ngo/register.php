...
<body>
    <div class="min-vh-100 d-flex flex-column bg-image">
        ...
        <?php
          ...
          <div class="row g-0 justify-content-center">
              <div class="alert col-sm-6 alert-success alert-dismissible fade show mt-2" role="alert">
                <strong>NGO registered successfully!</strong>
            ...
            <div class="row g-0 justify-content-center">
              <div class="alert col-sm-6  alert-danger alert-dismissible fade show mt-2" role="alert">
                <strong>NGO Adding Failed!</strong>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
              </div>
            <?php
        ...
        <div class="card text-center col-11 col-sm-6 m-auto shadow py-4 border-warning">
            ...
            <div class="card-body my-3">
                <h5 class="card-title text-uppercase lead mb-4 pb-1">NGO Registration</h5>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6 col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" aria-label="Name" placeholder="NGO Name" pattern="[A-Za-z ]{3,30}" title="min 3 chars - max 30 chars" required>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6 col-12">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" name="fid" id="fid" class="form-control" placeholder="NGO Id" required>
                                </div>
                            </div>
 ...
 $(document).ready(function () {
		...
		$("#fid").change(function () {
            ...
            var fidval1 = /^(ngo)([0-9]{1,3})$/;
           if(!fidval1.test(fidval) || fid == '')
                {
                alert('Please enter  valid ngo id.');
				 $("#email").focus();
                return false;
            }
        });
    ...
    function Validate() {
        ...
        debugger;
         ...
         if (!intRegexunamer.test(unamer)) {
             alert('Please enter a valid ngo name.');
             flag = false;
             return flag;
         }
         else {
