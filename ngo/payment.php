    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="fname" name="firstname" value="<?php echo $_SESSION["compname"];?>">
            <label for="email"><i class="fa fa-envelope"></i> Email</label>
            <input type="text" id="email" name="email" value="<?php echo $_SESSION["Farmer"];?>">
          ...
          <div class="col-50">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="text" id="amt" name="amt" placeholder="0000000">
              </div>
              <div class="col-50">
				...
				<select id="ngo" name="ngo" style=" width: 100%; margin-bottom: 20px;  padding: 12px;  border: 1px solid #ccc;  border-radius: 3px;">
					...
					<option>Sugandhi Foundation</option>
				</select>
              </div>
            </div>
          </div>
