        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
			  ...
			  <li class="nav-item">
                <a class="nav-link text-light home active" aria-current="page" href="totdonation.php" style="background: #FF970A;">
      ...
      <div class="table-responsive">
                        <table class="table table-striped table-hover table-bordered shadow-sm align-middle">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM `govtsch22_donations` ORDER by amt DESC limit 3 ";
