      ...
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link faculty" aria-current="page" href="makedonation.php"  >
			  ...
			  <li class="nav-item">
                <a class="nav-link text-light home active " aria-current="page" href="feedback.php" style="background: #FF970A;">
                  <span data-feather="users"></span>
                  Feedback
                </a>
              </li>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3 lead">Feedback Page</h1>
          </div>
...
<div class="row">
  <div class="col-200">
    <div class="container">
          <form id="form" name="form" method="GET" action="savefeedback.php" class="text-center" >
        ...
        <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-500">
                ...
                <textarea type="text" id="feedback" name="feedback" placeholder="Your Valuable Feedback" style="width:80%;height:250px"></textarea>
              </div>
