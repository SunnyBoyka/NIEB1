        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <form id="form" name="form" method="POST" action="savestudent.php" class="text-center" enctype="multipart/form-data">
            ...
            <div class="row justify-content-evenly mt-5">
              <div class="mb-3 col-md-4">
                <input type="submit" onclick="return Validator();" class="btn w-100 text-light" name="butsave" id="butsave"  style="background: #FF970A;" />
              </div>
            </div>
 <script>
     function Validator() {
  ...
  var usn = document.getElementById('usn').value;
         var intRegex = /^[1-4]{1}[a-zA-Z]{2}[0-9]{2}[A-Za-z]{2}[0-9]{3}$/;
