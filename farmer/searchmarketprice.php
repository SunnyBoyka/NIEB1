...
<head>
  ...
  <title>Search Market Price</title>
      ...
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link faculty text-light" aria-current="page" href="searchmarketprice.php" style="background: #FF970A;">
                  <span data-feather="search" class="text-light"></span>
                  Search Market Price
                </a>
              </li> 
              <li class="nav-item">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3 lead">Search Market Price</h1>
          </div>
          <?php
          ...
          <form id="form" name="form" method="GET" action="searchmarketprice.php" class="text-center" enctype="multipart/form-data">
            <h4 class="h4 text-center mb-4">Search Keyword</h4>

            <div class="row justify-content-center">
              <div class="col-md-6">
                <input type="text" name="search" id="search" class="form-control shadow-none" placeholder="Crop Name">
              </div>
              <div class="col-md-3 text-md-start">
                <button class="btn btn-primary w-100 shadow-none" type="submit">Search</button>
              </div>
            </div>
            ...
            <?php
              ...
              {
                echo ' <h4 class="h4 text-center mb-4">Results</h4>';

                $name = trim($_GET["search"]);

                $query = "select * from govtsch22_market_price where cropname like '%$name%'";
