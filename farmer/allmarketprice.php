      ...
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link faculty text-light" aria-current="page" href="allmarketprice.php" style="background: #FF970A;">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3 lead">View Market Prices</h1>
          </div>
          <?php
          ...
          <form id="form" name="form" class="text-center" enctype="multipart/form-data">
            <h4 class="h4 text-center mb-4">Market Prices</h4>
