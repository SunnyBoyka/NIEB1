      ...
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link student text-light" aria-current="page" href="addscheme.php" style="background: #FF970A;">
                  <span class=" text-light" data-feather="user-plus"></span>
                  Add Scheme
                </a>
              </li>
              <li class="nav-item">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3 lead">Add Scheme</h1>
          </div>
          <?php
          ...
          ?>
              <div class="alert alert-success alert-dismissible fade show mt-2" role="alert">
                <strong>Scheme Added Successfully!</strong>
            ...
            ?>
              <div class="alert alert-danger alert-dismissible fade show mt-2" role="alert">
                <strong>Scheme Adding Failed!</strong>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
            <?php
            }
          ...
          <form id="form" name="form" method="POST" action="savescheme.php" class="text-center" enctype="multipart/form-data">
            <h4 class="h4 text-center mb-4">Scheme Details</h4>
<!--
            <div class="row justify-content-evenly">
              <div class="mb-3 col-md-4">
                <label class="form-label">Scheme Name :</label>
                <input type="text" class="form-control shadow-none" name="name" id="name" placeholder="Scheme Name" required="required" />
              </div>
              <div class="mb-3 col-md-4">
                <label class="form-label">Scheme Type :</label>
                <select class="form-select shadow-none" name="stype" id="stype" required="required">
            ...
            <div class="row justify-content-evenly">
              <div class="mb-3 col-md-4">
                ...
                <input type="email" class="form-control shadow-none" name="email" id="email" placeholder="contact Email" required="required" />
              </div>
              <div class="mb-3 col-md-4">
                <label class="form-label">Contact Phone :</label>
                <input type="text" class="form-control shadow-none" name="cphone" id="cphone" placeholder="Contact Phone" required="required" />
              </div>
            </div>
            <div class="row justify-content-evenly">
              <div class="mb-12 col-md-12">
                <label class="form-label">Description :</label>
				<textarea rows="3" class="form-control shadow-none" name="descr" id="descr" placeholder="Scheme Description" ></textarea>
              </div>
              <div class="mb-3 col-md-4">
                <label class="form-label">Scheme URL :</label>
                <input type="text" class="form-control shadow-none" name="surl" id="surl" placeholder="Scheme URL"  />
              </div>
              <div class="mb-3 col-md-4">
                <label class="form-label">Scheme For :</label>
                <input type="text" class="form-control shadow-none" name="crop" id="crop" placeholder="Cropname"  />
              </div>
            </div>-->	
			
            <div class="row justify-content-evenly mt-5">
              <div class="mb-3 col-md-4">
                <input type="submit" value="Fetch Schemes from API" class="btn w-100 text-light" name="butsave" id="butsave"  style="background: #FF970A;" />
