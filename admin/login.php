    ...
    <div class="min-vh-100 d-flex flex-column bg-image">
        ...
        <div class="card text-center col-11 col-md-4 m-auto shadow py-4 border-warning">
            ...
            <div class="card-body my-3">
                <h5 class="card-title text-uppercase lead mb-4 pb-1">Admin Login</h5>
                    ...
                    <div class="col-md-10 col-12">
                      ...
                      <div class="col-md-10 col-12">
                        <div class="d-grid my-3">
                            <button class="btn text-white" style="background: #FF970A;" onclick="return Validator();" type="submit">Login</button>
							 <script>
     function Validator() {
         debugger;
         var flag = true;
