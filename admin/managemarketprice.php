...
<head>
  ...
  <title>Manage Market Price</title>
      ...
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link faculty text-light" aria-current="page" href="managemarketprice.php" style="background: #FF970A;">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3 lead">Manage Market Price</h1>
          </div>
          <?php
          ...
          ?>
              <div class="alert alert-success alert-dismissible fade show mt-2" role="alert">
                <strong>Market Price Updated Successfully!</strong>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
            <?php
            ...
            ?>
              <div class="alert alert-danger alert-dismissible fade show mt-2" role="alert">
                <strong>Market Price Updating Failed!</strong>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
            <?php
            }
          ...
          ?>
              <div class="alert alert-success alert-dismissible fade show mt-2" role="alert">
                <strong>Market Price Deleted Successfully!</strong>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
            <?php
            ...
            ?>
              <div class="alert alert-danger alert-dismissible fade show mt-2" role="alert">
                <strong>Market Price Deleting Failed!</strong>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
            <?php
            }
          ...
          <form id="form" name="form" method="POST" action="updatemarketprice.php" class="text-center">
            <h4 class="h4 text-center mb-4">Update Market Price</h4>
            ...
            <div class="row justify-content-evenly">
              <div class="mb-3 col-md-4">
                ...
                <select class="form-select shadow-none" name="cropname" id="cropname" required="required">
                  ...
                  <?php
                  $query = "select * from govtsch22_market_price";
                  ...
                  {
                  ?>
                   <option value="<?=$row["cropname"]?>" price="<?=$row["cropprice"]?>"><?=$row["cropname"]?></option>
                  <?php
                  }
                  ?>
                </select>
            ...
            <div class="row justify-content-evenly mt-3">
              <div class="mb-3 col-md-4">
                <input type="submit" class="btn w-100 text-light" name="butsave" id="butsave" style="background: #FF970A;" value="Update" />
          ...
          <form id="form" name="form" method="POST" action="deletemarketprice.php" class="text-center" enctype="multipart/form-data">
