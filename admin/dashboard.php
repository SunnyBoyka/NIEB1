      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <form id="form" name="form" method="POST" action="farmerdelete.php" class="text-center" enctype="multipart/form-data">
            <h4 class="h4 text-center mb-4">Farmer Details</h4>
                        ...
                        <table class="table table-striped table-hover table-bordered shadow-sm align-middle">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    $id = $row['id'];
                                    $govtsch22_farmname = $row['govtsch22_farmname'];
                                    $govtsch22_farmtype = $row['govtsch22_farmtype'];
                                    $govtsch22_farmid = $row['govtsch22_farmid'];
                                    $govtsch22_farmphone = $row['govtsch22_farmphone'];
                                    $govtsch22_farmemail = $row['govtsch22_farmemail'];
                                    $govtsch22_farmcrops = $row['govtsch22_farmcrops'];

                                    echo '<tr class="text-center">';
                                    echo '<td>' . $id . '</td>';
                                    echo '<td>' . $govtsch22_farmname . '</td>';
                                    echo '<td>' . $govtsch22_farmtype . '</td>';
                                    echo '<td>' . $govtsch22_farmid . '</td>';
                                    echo '<td>' . $govtsch22_farmphone . '</td>';
                                    echo '<td>' . $govtsch22_farmemail . '</td>';
                                    echo '<td>' . $govtsch22_farmcrops . '</td>';
