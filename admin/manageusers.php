      ...
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link faculty text-light" aria-current="page" href="manageusers.php" style="background: #FF970A;">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3 lead">Manage Farmers</h1>
          </div>
          <?php
                        ...
                        <table class="table table-striped table-hover table-bordered shadow-sm align-middle">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    $id = $row['id'];
                                    $sname = $row['govtsch22_farmname'];
                                    $stype = $row['govtsch22_farmtype'];
                                    $descr = $row['govtsch22_farmphone'];
                                    $crop = $row['govtsch22_farmemail'];
